                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <div class="p-3 border-bottom">
                                    ...
                                    <a href="{{ route('blog-details', ['id' => $blog->id]) }}" class="h4 card-title font-primary text-dark">{{ $blog->title }}</a>
                                    <p class="card-text">{{ \Illuminate\Support\Str::words($blog->short_description, 1 ,'....') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
