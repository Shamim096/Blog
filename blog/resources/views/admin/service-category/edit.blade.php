                        ...
                        <div class="card-body">
                            <form action="{{ route('update-service-category',['id' => $serviceCategory->id]) }}" method="post">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-8">
                                        <label for=""><input type="radio" name="status" {{ $serviceCategory->status == 1 ? 'checked' : '' }} value="1" checked> Published</label>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="submit" value="Update Service Category">
                                    </div>
                                </div>
                            </form>
                        </div>
